...
<p align="center">
  <img src="assets/terminal-table-example.png" alt="ターミナルのテーブル" width="400">
</p>
...
ショートカットキーはインストール後に変更できます：

| OS | 変更方法 |
|---|---|
| macOS | システム設定 → キーボード → キーボードショートカット → サービス → 「TableCopy」 |
| Windows | `%APPDATA%\TableCopy\tablecopy.ahk` を直接編集 |
